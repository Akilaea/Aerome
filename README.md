...
> **v1.2.1 是 v1.2.0 / v1.1.1 的安装器 hotfix**：之前的版本会把安装目录叠加成 `D:\Aerome\Aerome\Aerome\Aerome`，已修复；老版本用户直接覆盖安装 v1.2.1 即可。
...
正式分发以 Release 资产中的 `Aerome-1.2.1-Setup.exe` 为准。安装包会创建桌面快捷方式。
