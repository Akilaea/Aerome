...
!ifndef BUILD_UNINSTALLER
  !ifndef MUI_CUSTOMFUNCTION_GUIINIT
    !define MUI_CUSTOMFUNCTION_GUIINIT AeromeGuiInit
  !endif
!endif
...
!ifndef BUILD_UNINSTALLER
  ...
  Var AeromeBodyFont
  Var AeromeSmallFont
  Var AeromeDirectoryPage
  Var AeromeDirectoryInput
!endif
...
!macro customPageAfterChangeDir
  Page custom AeromeDirectoryShow AeromeDirectoryLeave
!macroend

!macro customFinishPage
  !ifndef HIDE_RUN_AFTER_FINISH
    Function AeromeFinishStartApp
      ${If} ${isUpdated}
        StrCpy $1 "--updated"
      ${Else}
        StrCpy $1 ""
    ...
    !define MUI_FINISHPAGE_RUN_FUNCTION "AeromeFinishStartApp"
  !endif
  !define MUI_PAGE_CUSTOMFUNCTION_SHOW AeromeTintCommonControls
  !insertmacro MUI_PAGE_FINISH
!macroend

!ifndef BUILD_UNINSTALLER
Function AeromeGuiInit
  ...
  Call AeromeTintCommonControls
FunctionEnd

Function AeromeTintCommonControls
...
Function AeromeUsePreferredInstallDir
  ${GetParameters} $R0
  ClearErrors
  ${GetOptions} $R0 "/D=" $R1
  ${IfNot} ${Errors}
...
Function AeromeWelcomeShow
  ...
  Pop $AeromeWelcomePage
  ${If} $AeromeWelcomePage == error
    Abort
  ${EndIf}

  SetCtlColors $AeromeWelcomePage "111217" "FFFFFF"
  CreateFont $AeromeHeroFont "Microsoft YaHei UI" 24 700
  CreateFont $AeromeTitleFont "Microsoft YaHei UI" 11 700
  CreateFont $AeromeBodyFont "Microsoft YaHei UI" 9 400
  CreateFont $AeromeSmallFont "Microsoft YaHei UI" 8 400

  ${NSD_CreateLabel} 22u 20u 82u 10u "AEROME"
  Pop $0
  SendMessage $0 ${WM_SETFONT} $AeromeSmallFont 1
  SetCtlColors $0 "3257F7" "FFFFFF"

  ${NSD_CreateLabel} 22u 42u 226u 30u "Aerome 安装"
  Pop $0
  SendMessage $0 ${WM_SETFONT} $AeromeHeroFont 1
  SetCtlColors $0 "111217" "FFFFFF"
  ...
  ${NSD_CreateLabel} 22u 96u 238u 24u "为这台电脑安装 Aerome。默认安装到 D:\Aerome，下一步可以自由选择其它位置。"
  Pop $0
  SendMessage $0 ${WM_SETFONT} $AeromeBodyFont 1
  SetCtlColors $0 "4B5263" "FFFFFF"

  ${NSD_CreateLabel} 22u 130u 238u 12u "默认位置：$INSTDIR"
  Pop $0
  SendMessage $0 ${WM_SETFONT} $AeromeTitleFont 1
  SetCtlColors $0 "3257F7" "FFFFFF"

  nsDialogs::Show
FunctionEnd

Function AeromeDirectoryBrowse
  nsDialogs::SelectFolderDialog "选择 Aerome 安装文件夹" "$INSTDIR"
  Pop $0
  ${If} $0 != error
  ${AndIf} $0 != ""
    Push "$0"
...
Function AeromeDirectoryShow
  Call AeromeUsePreferredInstallDir

  nsDialogs::Create 1018
  Pop $AeromeDirectoryPage
  ${If} $AeromeDirectoryPage == error
    Abort
  ${EndIf}

  SetCtlColors $AeromeDirectoryPage "111217" "FFFFFF"
  CreateFont $AeromeTitleFont "Microsoft YaHei UI" 15 700
  CreateFont $AeromeBodyFont "Microsoft YaHei UI" 9 400
  CreateFont $AeromeSmallFont "Microsoft YaHei UI" 8 500
  ...
  Pop $AeromeDirectoryInput
  SendMessage $AeromeDirectoryInput ${WM_SETFONT} $AeromeBodyFont 1
  SetCtlColors $AeromeDirectoryInput "111217" "FFFFFF"

  ${NSD_CreateBrowseButton} 210u 93u 50u 17u "浏览..."
  Pop $0
  SendMessage $0 ${WM_SETFONT} $AeromeSmallFont 1
  ${NSD_OnClick} $0 AeromeDirectoryBrowse

  ${NSD_CreateLabel} 22u 122u 238u 12u "默认推荐：D:\Aerome；选盘符会自动建文件夹。"
  Pop $0
  SendMessage $0 ${WM_SETFONT} $AeromeSmallFont 1
...
Function AeromeDirectoryLeave
  ${NSD_GetText} $AeromeDirectoryInput $0
  ${If} $0 == ""
